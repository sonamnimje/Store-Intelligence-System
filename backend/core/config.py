...
class Settings(BaseSettings):
    ...
    event_crowding_cooldown_seconds: int = Field(default=20, ge=1, le=3600)
    event_theft_risk_cooldown_seconds: int = Field(default=10, ge=1, le=3600)
    event_unusual_activity_cooldown_seconds: int = Field(default=15, ge=1, le=3600)
    event_lingering_cooldown_seconds: int = Field(default=30, ge=1, le=3600)

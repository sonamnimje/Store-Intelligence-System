...
async def seed_demo_records(session: AsyncSession) -> None:
    ...
    seed_events = [
        EventRecord(
            ...
            occurrence_count=18,
            is_active=False,
            event_metadata={"people_count": 14, "threshold": 8, "track_ids": [1, 2, 3, 4], "lifecycle_state": "closed"},
        ),
        EventRecord(
            event_id=str(uuid4()),
            ...
            occurrence_count=22,
            is_active=False,
            event_metadata={"track_id": 2, "track_key": "2", "track_ids": [2], "duration_seconds": 20, "lifecycle_state": "closed"},
        ),
        EventRecord(
            event_id=str(uuid4()),
            ...
            occurrence_count=6,
            is_active=False,
            event_metadata={"track_id": 7, "track_key": "7", "track_ids": [7], "lifecycle_state": "closed"},
        ),
    ]
    seed_alerts = [
        AlertRecord(
